...
def find_minimum_latency(lines):
    ...
    for current_vertex_label in graph.vertices:
        if current_vertex_label not in client_vertices:
            roadmap = graph.dijkstra(current_vertex_label)
            current_minimum_latency = max(roadmap[client_vertex] for client_vertex in client_vertices)

            if current_minimum_latency < minimum_latency:
                minimum_latency = current_minimum_latency
                print(current_vertex_label)
